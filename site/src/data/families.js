...
export const families = [
  {
    ...
    photos: [
      { src: "josip.webp", w: 360, h: 480,
        alt: "Hand-tinted studio portrait of a young man with a dark beard and a pale bow tie.",
        who: "Josip",
        cap: "Your 3× great-grandpa, the stonemason. Somebody painted the colours onto this photograph by hand — colour cameras had not been invented yet." },
      { src: "ana.webp", w: 366, h: 480,
        alt: "Hand-tinted studio portrait of a young woman in a high-necked dress with lace cuffs.",
        who: "Ana",
        cap: "Josip’s wife, and the other half of the pair. Same photographer, same day, and the same hand painted her colours on too." },
      { src: "ursula.webp", w: 241, h: 384,
        alt: "Worn photograph of a seated woman in a loose drop-waisted dress of the early 1920s.",
        who: "Ursula",
        cap: "Your 2× great-grandma. She was the mother of the brothers who all ended up far from home in Germany during the war." },
      { src: "parish-book.webp", w: 900, h: 635, wide: true,
        alt: "A ruled page from the parish book of souls, written in ink in Latin.",
        who: "The book of souls",
        cap: "The real page. House 5, and a farmer called Giovanni Battista born in 1787 — ruled into neat columns and written in Latin with a dip pen." },
    ],
    ladder: [
...

  {
    ...
    photos: [
      { src: "filomena.webp", w: 550, h: 733,
        alt: "An elderly woman in a spotted headscarf and a thick crocheted shawl, smiling slightly.",
        who: "Filomena",
        cap: "Your 2× great-grandma, born on 10 April 1897. Photographed when she was very old, in a spotted headscarf and a crocheted shawl she may well have made herself." },
      { src: "mystery-couple.webp", w: 550, h: 413,
        alt: "Two oval portraits of an elderly man and woman mounted side by side on card.",
        who: "Two people — and nobody knows who",
  ...
  },
  {
    ...
    photos: [
      { src: "bob-passport.webp", w: 855, h: 705, wide: true,
...

  {
    ...
    photos: [
      { src: "george-kolbe.webp", w: 633, h: 800,
        alt: "Painted portrait of a young man with reddish-brown curling hair, a high white stock and a tan coat.",
        who: "George Augustus Kolbe",
        cap: "A painting, not a photograph — he died in 1844, when cameras were only five years old. It was photographed through its glass, which is why there is a shine across his chest." },
      { src: "margaret-downing.webp", w: 631, h: 800,
        alt: "Heavily hand-retouched portrait of a woman with centre-parted hair and a plain white collar.",
        who: "Margaret Downing — probably",
        cap: "She married George when she was fifteen. This picture has been touched up by hand so heavily that we can only say it is probably her: the centre parting and plain collar fit the 1850s and 60s, and she died in 1867." },
      { src: "kolbe-grave.webp", w: 327, h: 485,
        alt: "A tall urn-topped monument inside a cast-iron railed enclosure in a dry grassy cemetery.",
        who: "The grave at Burgersdorp",
        cap: "Still standing, inside its iron fence. The stone says George was born in London on 7 December 1802 — and 200 years later we found the London church book, which says exactly the same day." },
    ],
    ladder: [
      { name: "A & M", where: "Brisbane, Australia", you: true },
      { name: "D", rel: "Dad", where: "Johannesburg, South Africa" },
