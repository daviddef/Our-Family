...
export const words = [
  ...
  { w: "Polistena", say: "po-lis-TEH-na", from: "Italian", k: "polistena",
    means: "A surname that is also a town. There is a Polistena in Calabria, and somewhere a long way back a family moved away from it and got called «the ones from Polistena» \u2014 so the name is really an address. A name made this way is called a toponymic." },
  { w: "graft", say: "grahft", from: "English", k: "britain",
    means: "In a garden, grafting is joining a cutting from one plant onto another so they grow as one. Family trees get grafted too \u2014 somebody joins a branch to the wrong trunk, and then everybody copies it. The D\u2019Arcy archive has found two of these, and everything hanging above them is marked so you know." },
  { w: "filatrice", say: "fee-la-TREE-cheh", from: "Italian", k: "prostamo",
    means: "A woman who spins thread. The Calabrian registers write the men\u2019s trades and the women\u2019s too, and this is the one that comes up: spinning wool or flax into yarn, at home, by hand." },
