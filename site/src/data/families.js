...
export const families = [
  {
    ...
    facts: [
      ...
      {
        big: "Grandpa Ivan was born in a town of the big wind.",
        text: "He was born at Senj, right on the Adriatic Sea, and named after his own father. Senj is famous for a wind called the bura, which comes roaring down off the mountains so hard that it can blow a person right over.",
      },
      {
    ...
    photos: [
      { src: "ursula.webp", w: 241, h: 384,
        alt: "Worn photograph of a seated woman in a loose drop-waisted dress of the early 1920s, the print worn away at every corner.",
        who: "Ursula",
        cap: "Your 2× great-grandma, photographed in the 1920s. She was the mother of the brothers who all ended up far from home in Germany during the war. The print has worn right down to the emulsion at every corner." },
