...
const raw = [
  ...
  { y: "17 Jun 1949", k: "polistena", t: "Two Polistenas on the same ship",
    w: "Antonino and Angela Polistena both stepped off the Surriento on the same June day. Angela was twenty-four. Four years later the man she would marry, Rocco Arena, sailed into Sydney on a ship called the Sydney \u2014 and their two families had grown up in sight of each other at Scilla." },
  { y: "27 Dec 1953", k: "arena", t: "Rocco lands two days after Christmas",
    w: "The passenger index gives the ship as the Sydney and the date as 27 December 1953. The family tree had recorded the crossing and not the ship." },
